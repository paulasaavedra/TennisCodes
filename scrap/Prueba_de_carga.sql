...
where tourney_name = 'Brazzaville'
    and round_match = '' -- Corregir nacionalidades World o null
UPDATE atp_simple
SET w_nac = 'United States'
WHERE w_nac IS NULL
    AND w_player = 'Brandon Nakashima';
UPDATE atp_simple
SET l_nac = 'United States'
WHERE l_nac IS NULL
    AND l_player = 'Brandon Nakashima';
UPDATE atp_simple
SET w_nac = 'Canada'
WHERE w_nac IS NULL
    AND w_player = 'Felix Auger Aliassime';
UPDATE atp_simple
SET l_nac = 'Canada'
WHERE l_nac IS NULL
    AND l_player = 'Felix Auger Aliassime';
UPDATE atp_simple
SET w_nac = 'Italy'
WHERE w_nac IS NULL
    AND w_player = 'Matteo Gigante';
UPDATE atp_simple
SET l_nac = 'Italy'
WHERE l_nac IS NULL
    AND l_player = 'Matteo Gigante';
UPDATE atp_simple
SET w_nac = 'Slovakia'
WHERE w_nac IS NULL
    AND w_player = 'Lukas Klein';
UPDATE atp_simple
SET l_nac = 'Slovakia'
WHERE l_nac IS NULL
    AND l_player = 'Lukas Klein';
UPDATE atp_simple
SET w_nac = 'Kazakhstan'
WHERE w_nac IS NULL
    AND w_player = 'Timofey Skatov';
UPDATE atp_simple
SET l_nac = 'Kazakhstan'
WHERE l_nac IS NULL
    AND l_player = 'Timofey Skatov';
UPDATE atp_simple
SET w_nac = 'Poland'
WHERE w_nac IS NULL
    AND w_player = 'Jasza Szajrych';
UPDATE atp_simple
SET l_nac = 'Poland'
WHERE l_nac IS NULL
    AND l_player = 'Jasza Szajrych';
UPDATE atp_simple
SET w_nac = 'Poland'
WHERE w_nac IS NULL
    AND w_player = 'Martin Damm';
UPDATE atp_simple
SET l_nac = 'Poland'
WHERE l_nac IS NULL
    AND l_player = 'Martin Damm';
UPDATE atp_simple
SET w_nac = 'France'
WHERE w_nac IS NULL
    AND w_player = 'Arthur Bouquier';
UPDATE atp_simple
SET l_nac = 'France'
WHERE l_nac IS NULL
    AND l_player = 'Arthur Bouquier';
UPDATE atp_simple
SET w_nac = 'Australia'
WHERE w_nac IS NULL
    AND w_player = 'James McCabe';
UPDATE atp_simple
SET l_nac = 'Australia'
WHERE l_nac IS NULL
    AND l_player = 'James McCabe';
UPDATE atp_simple
SET w_nac = 'Colombia'
WHERE w_nac IS NULL
    AND w_player = 'Nicolas Mejia';
UPDATE atp_simple
SET l_nac = 'Colombia'
WHERE l_nac IS NULL
    AND l_player = 'Nicolas Mejia';
UPDATE atp_simple
SET w_nac = 'Lithuania'
WHERE w_nac IS NULL
    AND w_player = 'Ricardas Berankis';
UPDATE atp_simple
SET l_nac = 'Lithuania'
WHERE l_nac IS NULL
    AND l_player = 'Ricardas Berankis';
UPDATE atp_simple
SET w_nac = 'France'
WHERE w_nac IS NULL
    AND w_player = 'Hugo Grenier';
UPDATE atp_simple
SET l_nac = 'France'
WHERE l_nac IS NULL
    AND l_player = 'Hugo Grenier';
UPDATE atp_simple
SET w_nac = 'Japan'
WHERE w_nac IS NULL
    AND w_player = 'Kaichi Uchida';
UPDATE atp_simple
SET l_nac = 'Japan'
WHERE l_nac IS NULL
    AND l_player = 'Kaichi Uchida';
UPDATE atp_simple
SET w_nac = 'Ukraine'
WHERE w_nac IS NULL
    AND w_player = 'Vitaliy Sachko';
UPDATE atp_simple
SET l_nac = 'Ukraine'
WHERE l_nac IS NULL
    AND l_player = 'Vitaliy Sachko';
UPDATE atp_simple
SET w_nac = 'Netherlands'
WHERE w_nac IS NULL
    AND w_player = 'Jesper De Jong';
UPDATE atp_simple
SET l_nac = 'Netherlands'
WHERE l_nac IS NULL
    AND l_player = 'Jesper De Jong';
UPDATE atp_simple
SET w_nac = 'Italy'
WHERE w_nac IS NULL
    AND w_player = 'Gabriele Pennaforti';
UPDATE atp_simple
SET l_nac = 'Italy'
WHERE l_nac IS NULL
    AND l_player = 'Gabriele Pennaforti';
UPDATE atp_simple
SET w_nac = 'Denmark'
WHERE w_nac IS NULL
    AND w_player = 'Elmer Moller';
UPDATE atp_simple
SET l_nac = 'Denmark'
WHERE l_nac IS NULL
    AND l_player = 'Elmer Moller';
UPDATE atp_simple
SET w_nac = 'Kazakhstan'
WHERE w_nac IS NULL
    AND w_player = 'Denis Yevseyev';
UPDATE atp_simple
SET l_nac = 'Kazakhstan'
WHERE l_nac IS NULL
    AND l_player = 'Denis Yevseyev';
UPDATE atp_simple
SET w_nac = 'Australia'
WHERE w_nac IS NULL
    AND w_player = 'Jordan Thompson';
UPDATE atp_simple
SET l_nac = 'Australia'
WHERE l_nac IS NULL
    AND l_player = 'Jordan Thompson';
UPDATE atp_simple
SET w_nac = 'Bulgaria'
WHERE w_nac IS NULL
    AND w_player = 'Adrian Andreev';
UPDATE atp_simple
SET l_nac = 'Bulgaria'
WHERE l_nac IS NULL
    AND l_player = 'Adrian Andreev';
UPDATE atp_simple
SET w_nac = 'Belgium'
WHERE w_nac IS NULL
    AND w_player = 'Alexander Blockx';
UPDATE atp_simple
SET l_nac = 'Belgium'
WHERE l_nac IS NULL
    AND l_player = 'Alexander Blockx';
UPDATE atp_simple
SET w_nac = 'Italy'
WHERE w_nac IS NULL
    AND w_player = 'Andrea Pellegrino';
UPDATE atp_simple
SET l_nac = 'Italy'
WHERE l_nac IS NULL
    AND l_player = 'Andrea Pellegrino';
UPDATE atp_simple
SET w_nac = 'United States'
WHERE w_nac IS NULL
    AND w_player = 'Brandon Holt';
UPDATE atp_simple
SET l_nac = 'United States'
WHERE l_nac IS NULL
    AND l_player = 'Brandon Holt';
UPDATE atp_simple
SET w_nac = 'Italy'
WHERE w_nac IS NULL
    AND w_player = 'Enrico Dalla Valle';
UPDATE atp_simple
SET l_nac = 'Italy'
WHERE l_nac IS NULL
    AND l_player = 'Enrico Dalla Valle';
UPDATE atp_simple
SET w_nac = 'France'
WHERE w_nac IS NULL
    AND w_player = 'Gael Monfils';
UPDATE atp_simple
SET l_nac = 'France'
WHERE l_nac IS NULL
    AND l_player = 'Gael Monfils';
UPDATE atp_simple
SET w_nac = 'United Kingdom'
WHERE w_nac IS NULL
    AND w_player = 'George Loffhagen';
UPDATE atp_simple
SET l_nac = 'United Kingdom'
WHERE l_nac IS NULL
    AND l_player = 'George Loffhagen';
UPDATE atp_simple
SET w_nac = 'Argentina'
WHERE w_nac IS NULL
    AND w_player = 'Guido Andreozzi';
UPDATE atp_simple
SET l_nac = 'Argentina'
WHERE l_nac IS NULL
    AND l_player = 'Guido Andreozzi';
UPDATE atp_simple
SET w_nac = 'France'
WHERE w_nac IS NULL
    AND w_player = 'Harold Mayot';
UPDATE atp_simple
SET l_nac = 'France'
WHERE l_nac IS NULL
    AND l_player = 'Harold Mayot';
UPDATE atp_simple
SET w_nac = 'Belgium'
WHERE w_nac IS NULL
    AND w_player = 'Kimmer Coppejans';
UPDATE atp_simple
SET l_nac = 'Belgium'
WHERE l_nac IS NULL
    AND l_player = 'Kimmer Coppejans';
UPDATE atp_simple
SET w_nac = 'Serbia'
WHERE w_nac IS NULL
    AND w_player = 'Laslo Djere';
UPDATE atp_simple
SET l_nac = 'Serbia'
WHERE l_nac IS NULL
    AND l_player = 'Laslo Djere';
UPDATE atp_simple
SET w_nac = 'France'
WHERE w_nac IS NULL
    AND w_player = 'Lilian Marmousez';
UPDATE atp_simple
SET l_nac = 'France'
WHERE l_nac IS NULL
    AND l_player = 'Lilian Marmousez';
UPDATE atp_simple
SET w_nac = 'Kazakhstan'
WHERE w_nac IS NULL
    AND w_player = 'Mikhail Kukushkin';
UPDATE atp_simple
SET l_nac = 'Kazakhstan'
WHERE l_nac IS NULL
    AND l_player = 'Mikhail Kukushkin';
UPDATE atp_simple
SET w_nac = 'Brazil'
WHERE w_nac IS NULL
    AND w_player = 'Orlando Luz';
UPDATE atp_simple
SET l_nac = 'Brazil'
WHERE l_nac IS NULL
    AND l_player = 'Orlando Luz';
UPDATE atp_simple
SET w_nac = 'Austria'
WHERE w_nac IS NULL
    AND w_player = 'Sandro Kopp';
UPDATE atp_simple
SET l_nac = 'Austria'
WHERE l_nac IS NULL
    AND l_player = 'Sandro Kopp';
UPDATE atp_simple
SET w_nac = 'Italy'
WHERE w_nac IS NULL
    AND w_player = 'Stefano Travaglia';
UPDATE atp_simple
SET l_nac = 'Italy'
WHERE l_nac IS NULL
    AND l_player = 'Stefano Travaglia';
UPDATE atp_simple
SET w_nac = 'China'
WHERE w_nac IS NULL
    AND w_player = 'Yan Bai';
UPDATE atp_simple
SET l_nac = 'China'
WHERE l_nac IS NULL
    AND l_player = 'Yan Bai';
UPDATE atp_simple
SET w_nac = 'Turkey'
WHERE w_nac IS NULL
    AND w_player = 'Yanki Erel';
UPDATE atp_simple
SET l_nac = 'Turkey'
WHERE l_nac IS NULL
    AND l_player = 'Yanki Erel';
UPDATE atp_simple
SET w_nac = 'Japan'
WHERE w_nac IS NULL
    AND w_player = 'Yasutaka Uchiyama';
UPDATE atp_simple
SET l_nac = 'Japan'
WHERE l_nac IS NULL
    AND l_player = 'Yasutaka Uchiyama';
UPDATE atp_simple
SET w_nac = 'Hungary'
WHERE w_nac IS NULL
    AND w_player = 'Zsombor Piros';
UPDATE atp_simple
SET l_nac = 'Hungary'
WHERE l_nac IS NULL
    AND l_player = 'Zsombor Piros';
UPDATE atp_simple
SET w_nac = 'Belarus'
WHERE w_nac = 'World'
    AND w_player = 'Egor Gerasimov';
UPDATE atp_simple
SET l_nac = 'Belarus'
WHERE l_nac = 'World'
    AND l_player = 'Egor Gerasimov';
UPDATE atp_simple
SET w_nac = 'Russia'
WHERE w_nac = 'World'
    AND w_player = 'Semen Pankin';
UPDATE atp_simple
SET l_nac = 'Russia'
WHERE l_nac = 'World'
    AND l_player = 'Semen Pankin';
UPDATE atp_simple
SET w_nac = 'Belarus'
WHERE w_nac = 'World'
    AND w_player = 'Erik Arutiunian';
UPDATE atp_simple
SET l_nac = 'Belarus'
WHERE l_nac = 'World'
    AND l_player = 'Erik Arutiunian';
UPDATE atp_simple
SET w_nac = 'Russia'
WHERE w_nac = 'World'
    AND w_player = 'Kirill Kivattsev';
UPDATE atp_simple
SET l_nac = 'Russia'
WHERE l_nac = 'World'
    AND l_player = 'Kirill Kivattsev';
UPDATE atp_simple
SET w_nac = 'Russia'
WHERE w_nac = 'World'
    AND w_player = 'Aleksandr Lobanov';
UPDATE atp_simple
SET l_nac = 'Russia'
WHERE l_nac = 'World'
