...
UPDATE atp_simple
SET TOURNEY_LEVEL = 'DC'
WHERE TOURNEY_NAME = 'Davis Cup';
UPDATE atp_simple
SET TOURNEY_LEVEL = 'GS'
...
WHERE l_player LIKE 'Felix Auger Aliassime';
UPDATE atp_simple
SET w_nac = REPLACE(
        w_nac,
        'France',
...
WHERE w_player LIKE 'Felix Auger Aliassime';
-----------------
select *
from atp_simple
...
update atp_simple
set l_nac = 'Russia'
where match_id = "2025_2941_183900"