...
def scrap_match(ides, URL):
    ...
    d_simple_check = "SI"
    data_simple.to_csv(
        "/Users/Paula/Documents/TennisData/TennisData/FS_matches/2025/simple/"
        + name_file,
        index=False,
        header=None,
    )
    ...
    d_stat_check = "SI"
    df_data_stat.to_csv(
        "/Users/Paula/Documents/TennisData/TennisData/FS_matches/2025/stats/"
        + name_file,
        index=False,
        header=True,
    )
    ...
    d_pbyp_check = "SI"
    pbyp.to_csv(
        "/Users/Paula/Documents/TennisData/TennisData/FS_matches/2025/pbyp/"
        + name_file,
        index=False,
        header=None,
    )
...
ides = "1214"
link_one_match = (
    "https://www.flashscore.com/match/rR46Q9LP/#/match-summary/match-summary"
)
